    ...
    return (<div id="gallery-page">
        <div className="images-container">
            <div className="column-image">
                <img src="https://images.unsplash.com/photo-1584627404349-0bb529b998b7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" alt="Sung_jin_cho_photo" />
                ...
                <img src="https://images.unsplash.com/photo-1551734044-8cf6396c8639?ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80" alt=""/>
            </div>
            <div className="column-image">
